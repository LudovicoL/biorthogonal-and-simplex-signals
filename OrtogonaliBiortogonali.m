...
hold;
grid on;
semilogy(Eb_No_dB,Ortg_Pe(1,:),colors1(1));     % Simplex: colorato normalmente.
semilogy(Eb_No_dB,Pe(2,:),'r:');
semilogy(Eb_No_dB,Ortg_Pe(2,:),colors1(2));
semilogy(Eb_No_dB,Pe(3,:),'b:');
semilogy(Eb_No_dB,Ortg_Pe(3,:),colors1(3));
semilogy(Eb_No_dB,Pe(4,:),'g:');
semilogy(Eb_No_dB,Ortg_Pe(4,:),colors1(4));
...
name_figure=['OrtogonaliVSBiortogonali_',num2str(data),' Figure'];
